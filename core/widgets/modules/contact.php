							...
							<div class="layers-content">
								<p class="layers-form-item">
									...
									<small class="layers-small-note">
										<?php _e( sprintf( 'Need to create a contact form? Try <a href="%s" target="ejejcsingle">Gravity Forms</a>', 'https://www.e-junkie.com/ecom/gb.php?cl=54585&c=ib&aff=221037' ) , 'layerswp' ); ?>
									</small>
								</p>
							</div>
						</div>
